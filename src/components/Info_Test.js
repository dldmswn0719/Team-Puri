...
function Info_Test() {
  ...
  return (
    <>
      ...
      <div className="w-full h-full  dark:bg-[#272929] overflow-x-hidden flex justify-center items-center mx-auto">
        <div className="w-[1200px] h-full">
          ...
          <div className="">
            <div className="section1">
              <div className="mt-[50px] md:text-left sm:w-auto sm:text-left">
              ...
              <div className="mt-[50px] md:text-right sm:w-auto sm:text-right">
            ...
            <div className="section2">
                          <div className="mt-[60px] text-right text-[#162C58] dark:text-[#ebf4f1]">
