            ...
            <div className="w-[1200px] mx-auto flex justify-between items-center my-6">
                ...
                <div className='w-[50%]'>
                    <ul className='flex justify-between'>
                        ...
                        <li className='hover:font-bold text-[16px]  text-center after:transition-all basis-full relative after:w-0 hover:after:w-full hover:after:h-[3px] hover:after:absolute hover:after:bg-[#162c58] hover:after:bottom-[-23px] hover:after:left-0'><NavLink to="/review_page" className="text-[#797979] hover:text-[#222]">입양후기</NavLink></li>
