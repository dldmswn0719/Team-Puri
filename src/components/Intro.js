  ...
  return (
    ...
    {/*  container*/}
        <div className="w-[1200px] h-[500px] bg-white mt-[100px] mb-auto mx-auto">
            ...
            <p className='text-[48px] tracking-[-4px] text-[#162C58] animate__animated animate__backInLeft'>우리의 <span className='font-bold tracking-[-5px]'>작은 친구들을 위한 </span>특별한 보호소</p>
            </div>
            <div className="text-center ">
            <p className='text-[#162C58] text-[20px]  tracking-[-2px] animate__animated animate__backInRight animate__delay-1s	1s'>애정 어린 소리로 유기동물을 지칭하는 이름으로, 보호와 관심을 나타냅니다.
            </p>
        </div>
        ...
        <div className="">
            ...
            text-[20px] text-[#162C58] tracking-[-3px]">푸리푸리</span><span className='text-[20px] text-[#162C58]'>는</span>
            ...
            <div className="flex justify-around">
                <div className="w-1/2">
                    ...
                    font-bold tracking-[-3px] ">푸리푸리</span><span className='tracking-[-3px] text-[20px]'>는</span>
                    ...
                    <div className="mt-[60px] text-right text-[#162C58]">
                <span className="font-bold
                text-[20px] tracking-[-1px]">함께해주세요.</span>
