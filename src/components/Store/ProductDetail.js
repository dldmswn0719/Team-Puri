    ...
    return (
        <>
            <div className="w-full bg-white dark:bg-[#272929]">
                <div className="max-w-7xl detail p-5 mx-auto">
                    ...
                    <div className="text-center dark:text-[#ebf4f1]">
                        ...
                        <div className="flex justify-center pb-[67px] gap-x-[14%]">
                            <div className="pt-[50px] dark:text-[#ebf4f1]">
                                ...
                                <p className="font-bold lg:text-[23px] pt-10">{messages.desc5}</p>
                            ...
                            <div className="pt-[50px]">
                                ...
                                <p className="font-bold lg:text-[23px] pt-10">{messages.desc9}</p>
                                <div className="lg:text-xl leading-8">
                                    <p>{messages.desc10}</p>
                                    <p>{messages.desc11}</p>
                                    <p>{messages.desc12}</p>
