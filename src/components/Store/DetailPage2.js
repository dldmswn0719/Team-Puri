                    ...
                    <div className={`relative overflow-hidden ${close === false ? 'h-[500px]' : 'h-auto'}`}>
                        {
                            ...
                            return (
                                <img key={i} className='mx-auto my-0 py-[20px] dark:text-[#ebf4f1]' src={e[1]} alt={data.name} />
                            )
                            })
                        }
                        <div onClick={()=>{setClose(close === false ? true : false)}} className="w-[930px] bottom-0 bg-white absolute h-[80px] border border-[#D5C09F] ml-[11%] dark:border-[#dadbdb] dark:text-[#ebf4f1] dark:bg-[#272929]">
                        ...
                        <div className="text-xl leading-[35px] pb-10 text-[#DAC0A3] dark:text-[#ebf4f1]">
                            <p className='title2'>사랑하는 존재를 더욱 사랑하도록</p>
                            <p className='title2'>아파하는 존재가 다시 사랑받도록</p>
                        </div>
                        <img className='mx-auto my-0 mb-[110px]' src="./../Images/logo_s1.png" alt="로고" />
                    </div>
                </div>
            </div>
        </div>
