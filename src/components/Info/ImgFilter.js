        ...
        <>
            ...
            <p>페이지 : {page}</p> */}
                    ...
                    <div className="max-w-full my-10 border-b-2 border-[#102C57]  ">
                        <div className="max-w-full h-full flex justify-between text-left   max-md:hidden">
                            <div className="">
                            ...
                            <div className="flex items-center">
                                <button className="font-bold w-48 h-12  border-2 border-[#55595e] rounded-[20px]"
                                    onClick={() => {
                                        setLoading(true);
                                        ResultData();
                                    }}>검색하기</button>
                    ...
                    <div className="flex text-[15px] gap-y-4 flex-wrap justify-start gap-x-3  max-md:justify-center max-lg:justify-center ">
                        {
                                    ...
                                    return (
                                        <div className="relative box-border border border-[#f1f1ef] flex-wrap basis-[32.5%] shadow-[4px_4px_4px_-4px_rgb(119, 112, 112)] rounded-[20px] " key={i}>
                                            <Link to={`/infodetail/${e.desertionNo}`} state={{ e: e }}>
                                                <div className='font-bold px-3 py-3 flex items-center justify-between max-md:w-[350px] max-lg:w-[300px]'>
