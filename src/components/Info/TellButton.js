    ...
    return (
        <>
            <div className="flex flex-col ">
                <p className='lg:hidden mt-5  text-[#999] md:text-sm sm:text-sm fold:text-sm dark:text-[#ebf4f1]  '>전화 문의는 평일 <span className='md:text-sm sm:text-sm fold:text-sm font-bold text-black dark:text-[#26332f] '>오전 9시</span>부터 <span className='md:text-sm sm:text-sm fold:text-sm font-bold text-black dark:text-[#ebf4f1] '>오후 6시</span>까지 입니다.</p>
