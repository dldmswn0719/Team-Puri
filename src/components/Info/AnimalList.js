                    ...
                    <div className="min-w-full max-h-full max-md:border-none sm:border-none fold:border-none border-b-4 border-[#86bcd5] dark:border-[#dadbdb] py-5 px-4 md:px-9 sm:px-11 ">
                        <div className="max-w-full h-full flex sm:flex-col fold:flex-col justify-between text-left">
                            ...
                            <div className="w-full flex items-center justify-end sm:justify-center  font-bold">
                                <button className="text-white font-bold w-48  h-12 md:w-48 sm:w-full  fold:w-full  max-md:mt-7 border-2 rounded-[20px] bg-[#86bcd5] border-[#86bcd5] dark:bg-[#272929] dark:text-[#ebf4f1] dark:border-[#dadbdb]"
                                    onClick={() => {
                                        setLoading(true);
                                        ResultData();
                                        PageReset();
