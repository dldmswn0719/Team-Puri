...
function Content2Info() {
    ...
    return (
        ...
        <div className='bg-white dark:bg-[#292929]'>
            <div className='md:w-[768px] lg:w-[1200px] m-auto flex items-center pb-10
            ...
            pt-20 md:pb-20 md:pt-36 lg:py-64 relative'>
                ...
                <div>
                    <img src={
                        language === 'en' ? `./../../Images/Main/im-dark.png` : `./../../Images/Main/im.png`
                    } alt="content" className="w-80 lg:block hidden
                    lg:w-3/5 lg:absolute lg:-right-16 lg:top-1/2 lg:-translate-y-1/2" />
