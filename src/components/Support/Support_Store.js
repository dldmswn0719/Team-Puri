        ...
        <>  
            <div className="support w-full h-[650px] overflow-hidden">
                <div className="w-[1200px] h-full items-center pl-[10%]" >
                    ...
                    <div className='h-1/2 translate-y-1/3'>
                        <NavLink to="/supportpay" className="w-[190px] h-[75px] bg-[#86bcd5] rounded-[50px] flex justify-center items-center text-white text-xl dark:bg-[#404343] max-lg:w-[150px] max-lg:text-[16px] max-lg:h-[50px] max-md:w-[100px] max-md:h-[35px] max-md:text-[14px]">{messages.support4}</NavLink>
                    </div>
                </div>
            </div>
            <div className="w-full dark:bg-[#272929] overflow-hidden">
                <div className="w-[1200px] pb-[70px] my-0 mx-auto max-lg:w-10/12 max-md:w-3/4">
                    <div className="text-center pt-[30px] text-3xl font-bold max-lg:text-[25px] dark:text-[#ebf4f1] ">
                        <FontAwesomeIcon className='text-[#86bcd5]' icon={faStore} />
                        <p className='pt-1'>{messages.supstoretitle}</p>
                    </div>     
                    <div className="flex justify-center items-center w-[960px] h-[75px] bg-[#86bcd5] text-white mt-[30px] mb-[50px] mx-auto max-lg:w-full max-md:w-full max-lg:h-[60px] max-md:h-[60px] dark:bg-[#404343]">
                        ...
                        <div className="w-full flex flex-wrap justify-between gap-y-[20px]">
                            <div className="w-[280px] max-md:w-[49%] max-lg:w-[32%]">
                                <NavLink to='/store/2'>
                                    ...
                                    <div className="w-full py-[30px] bg-[#86bcd5] text-white text-[16px] text-center dark:bg-[#404343]">
