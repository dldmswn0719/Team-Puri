        ...
        <>  
            <div className="support w-full h-[650px] overflow-hidden">
                <div className="w-[1200px] h-full items-center pl-[10%]" >
                    ...
                    <div className='h-1/2 translate-y-1/3 mt-[-15px]'>
                        <NavLink to="/supportpay" className="bg-[#DAC0A3] rounded-[50px] flex justify-center items-center text-white dark:bg-[#404343] lg:w-[150px] lg:text-[16px] lg:h-[50px] md:w-[150px] md:text-[16px] md:h-[50px] w-[100px] h-[35px] text-[13px] fold:w-[90px] fold:text-[12px]">{messages.support4}</NavLink>
                    </div>
                </div>
            </div>
            <div className="w-full dark:bg-[#272929] overflow-hidden">
                <div className="lg:w-9/12 pb-[70px] my-0 mx-auto md:w-5/6 w-11/12 fold:w-10/12">
                    <div className="text-center pt-[30px] lg:text-3xl font-bold md:text-3xl text-[25px] dark:text-[#ebf4f1]">{messages.supstoretitle}</div>
                    <div className="flex justify-center items-center lg:w-11/12 h-[75px] bg-[#f8f0e5] mt-[30px] mb-[50px] mx-auto  md:w-full w-full lg:h-[70px] md:h-[75px] dark:bg-[#404343]">
                        ...
                        <div className="w-full flex flex-wrap justify-between gap-y-[20px]">
                            <div className="lg:w-[24%] w-[49%] md:w-[32%] fold:w-full">
                                <NavLink to='/store/2'>
                                    ...
                                    <div className="w-full py-[30px] bg-[#f8f0e5] text-[16px] dark:bg-[#404343] pl-2 sm:py-3 fold:py-3">
                            ...
                            <div className="lg:w-[24%] w-[49%] md:w-[32%] fold:w-full">
                                <NavLink to='/store/3'>
                                    ...
                                    <div className="w-full py-[30px] bg-[#f8f0e5] text-[16px] pl-2 dark:bg-[#404343] sm:py-3 fold:py-3">
