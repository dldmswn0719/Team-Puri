                ...
                <div className="w-[500px] relative py-[50px] info  max-lg:w-full">
                  ...
                  <ul className="flex justify-between">
                    ...
                    <div className="w-[353px] h-[80px] flex justify-between flex-wrap">
                      ...
                      <li className="" onClick={()=>{setMoney(money === false ? true : false)}}><input type="text" placeholder="직접입력"  onInput={NumChk}  className='w-[105px] h-[28px] flex justify-center items-center text-center border-[1px] border-black' maxLength={11} /></li> 
